...
saveFolder = saveFolder + '/HMI_Experiments/TestEvolutionMethods/Standard/FluxImb/'
...
# # Time ACWE
# timeFile = os.path.join(ROOT_DIR,'HMI_Experiments/TestEvolutionMethods/Standard/')
# timeFile = timeFile + CR + '_timeStandard_FluxImb.csv'
