...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 24 16:04:16 2024
...
saveFolder = saveFolder + '/HMI_Experiments/TestEvolutionMethods/Standard_history/Uni/'
...
# timeFile = timeFile + CR + '_timeStandard_Uni.csv'
...
def itterateACWE2(I,im_size,sd_mask,m,foreground_weight=1,
    ...
    while iterate:
        ...
        for i in range(N):
            seg = acwe_exp2.acwe(I_seg,m_seg,1,(0,0,foreground_weight,
                                                background_weight,
                                                inunipolarityweight,
...
for i in range(len(data[keys[acweChoices[0]]])): #range(len(data[keys[acweChoices[0]]])-1, 0,-1):
    ...
    if overwrite or not os.path.exists(crSaveFolder + acweFile):
        ...
        # RUN ACWE
        seg,history = itterateACWE2(Imini,Ishape,sd_mask,m,foreground_weight,
        ...
        as5.saveSeg(crSaveFolder + acweFile,seg,H,correctLimbBrightening,
                    resize_param,foreground_weight,background_weight,history,
