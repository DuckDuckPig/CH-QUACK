...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 22 11:25:40 2024
...
from ACWE_python_fall_2023.ACWE_python_v3 import correct_limb_brightening as clb, acwe_exp4
...
saveFolder = saveFolder + '/HMI_Experiments/TestEvolutionMethods/Scaled/Skew/'
...
# if resize_param == 8:
#     timeFile = timeFile + '_timeStandard_Skew.csv'
# else:
#     timeFile = timeFile + '_time' + acwePrefix + '_Skew.csv'
...
def itterateACWE2(I,im_size,sd_mask,m,foreground_weight=1,
    ...
    while iterate:
        seg = acwe_exp4.acwe(I_seg,m_seg,N,(0,0,foreground_weight,
                                            background_weight,
                                            inunipolarityweight,
