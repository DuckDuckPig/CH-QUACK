...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 23 10:35:19 2024
...
saveFolder = saveFolder + '/HMI_Experiments/TestEvolutionMethods/Scaled/Uni/'
...
# if resize_param == 8:
#     timeFile = timeFile + '_timeStandard_Uni.csv'
# else:
#     timeFile = timeFile + '_time' + acwePrefix + '_Uni.csv'
