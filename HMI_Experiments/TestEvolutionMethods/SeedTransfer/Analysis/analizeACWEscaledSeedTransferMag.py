...
saveFolderScaled  = folderBase + 'TestEvolutionMethods/Scaled/'   # Update to reflect Dataset Location
saveFolderDefault = folderBase + 'TestEvolutionMethods/SeedTransfer/' # Update to reflect Dataset Location
...
resultsFolder = 'HMI_Experiments/TestEvolutionMethods/SeedTransfer/Analysis/Results/'
resultsFolder = os.path.join(ROOT_DIR,resultsFolder)
if not os.path.exists(resultsFolder):
    os.mkdir(resultsFolder)
filename = os.path.basename(CarringtonFile) + '.' + magMethod + '.SeedTransfer.npz'
