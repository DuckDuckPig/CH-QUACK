...
# -*- coding: utf-8 -*-
"""
Created on Thu May  2 15:31:15 2024
...
for i in range(size-2,-1,-3):
    ...
    if not os.path.exists(title) or overwrite:
        ...
        # Inform User
        if verbose:
            print(os.path.basename(orig[imageIndexUnotCH[i]]))
            print('Seed Group:', indexUnotCH[i] + 1)
            print('    Opening Segmentation')
        
        # Open Segmentation
        H,AH,SEG = acweSaveSeg_v5.openSeg(orig[imageIndexUnotCH[i]])
